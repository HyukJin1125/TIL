...
<%//service단에서 던져진 에러는 jsp에서 처리하도록 합시다..
		...
		<nav class="text-center">
			<ul class="pagination">
				...
				<c:if test="${searchVO.lastPage!=searchVO.totalPageCount }">
					<li><a href="freeList.jsp?curPage=${searchVO.lastPage+1 }" data-page="${searchVO.lastPage+1 }"><span
							aria-hidden="true">&gt;</span></a></li>
				</c:if>

				<!-- 마지막 페이지 -->
				<li><a href="freeList.jsp?curPage=${searchVO.totalPageCount }" data-page="${searchVO.totalPageCount }"><span
