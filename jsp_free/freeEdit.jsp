				...
				<table class="table table-striped table-bordered">
					...
					<tr>
						...
						<td>${freeBoard.boNo }<input type="hidden" name="boNo"
							value="${freeBoard.boNo }"> 글번호는 바꿀수 없지
						</td>
					...
					<tr>
						...
						<td>${freeBoard.boWriter }<input type="hidden"
							name="boWriter" value="${freeBoard.boWriter }"> 작성자도 바꿀수
							없지
						</td>
					</tr>
					<tr>
							...
							required="required">
								...
								<c:forEach items="${categoryList }" var="category">
									<option value="${category.commCd }"
										${freeBoard.boCategory eq category.commCd ? "selected='selected'" : ""}>
										${category.commNm }</option>
								</c:forEach> 
						</select></td>
					</tr>
					<tr>
