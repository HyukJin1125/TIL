...
public class FileBasic {
	...
	public static void main(String[] args) {
		...
		File temp = new File("/home/pc23/temp");
		...
		// 파일 만들기
		File test = new File("/home/pc23/test/test.txt");
		...
		// /home/pcxx/test폴더 안에 students 리스트에 있는
		// 학생들 폴더를 만들어주세요.
		
		for(int i = 0; i < students.size(); i++) {
			File stu = new File("/home/pc23/test/" + students.get(i));
			stu.mkdir();
		}
