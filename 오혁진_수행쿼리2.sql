...
CREATE user java2 identified by oracle   -- 시험 문제니깐 보기
...
ALTER TABLE ex_MEM MODIFY MEM_NAME VARCHAR2(50);  -- 컬럼사이즈 변경 시험
...
INSERT INTO ex_MEM (MEM_ID) VALUES('hong');         -- 시험공부하기
