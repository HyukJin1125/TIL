	...
	<tbody>
		<c:forEach items="${freeBoardList }" var="freeBoard">
			<tr class="text-center">
				...
				<td>${freeBoard.boRegDate  eq null  ? freeBoard.boRegDate : freeBoard.boModDate}</td>
		...
		<nav class="text-center">
			<ul class="pagination">
				...
				<c:if test="${pagingVO.firstPage ne 1 }">
					<li><a href="freeList.jsp?curPage=${pagingVO.firstPage-1 }" data-page="${pagingVO.firstPage-1 }"><span aria-hidden="true">&lt;</span></a></li>
				</c:if>
				<!-- 페이지 넘버링  -->
				...
				<c:if test="${pagingVO.lastPage ne pagingVO.totalPageCount }">
					<li><a href="freeList.jsp?curPage=${pagingVO.lastPage+1 }" data-page="${pagingVO.lastPage+1 }"><span aria-hidden="true">&gt;</span></a></li>
				</c:if>
				<!-- 마지막 페이지 -->
